...
class NyxDialog extends FlxSpriteGroup
{
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.SPACE #if android || justTouched #end)
		{
			cleanDialog();
		}
	...
	function startDialogue():Void
	{
		...
		currentTween = FlxTween.tween(currDialog, {alpha: 1}, fadeTime, {ease: FlxEase.quadInOut, onComplete: function(twn:FlxTween)
		{
			holdDialogue();
		}});
	}
