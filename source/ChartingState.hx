...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var seekBar:FlxSprite;
	var seekArrow:FlxSprite;
	var seekbarInitialX = 680;
	var seekbarInitialY = 440;
	...
	function addNoteUI():Void
	{
		...
		var resetLength:FlxButton = new FlxButton(200, 10, 'Reset Length', ResetLength);

		tab_group_note.add(stepperSusLength);
		tab_group_note.add(applyLength);
		tab_group_note.add(resetLength);
	...
	{
		var realOffset = note.strumTime - FlxG.save.data.offset;
		trace("Strum time:");
		for (i in _song.notes[curSection].sectionNotes)
		{
